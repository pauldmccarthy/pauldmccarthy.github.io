...
\citemnobullet \textit{Oxford Centre for Integrative Neuroimaging (OxCIN/FMRIB), UK}
...
in Python.
\item \href{https://fsl.fmrib.ox.ac.uk/fsl/docs/#/development/management/index}{\textbf{The FSL build system}} - an automated modular
...
for building FSL on Apple Silicon, and made substantial improvements
to the build processes for our C++/CUDA applications to achieve
compatibilty across a wide range of GPU hardware
...
markdown-based framework (\href{https://docsify.js.org/}{Docsify}). I organised
...
\begin{itemize}
\item \indent Go Figure: Transparency in neuroscience images preserves context and
clarifies interpretation
\newline
\item \indent MMORF—FSL's MultiMOdal Registration Framework\newline
\item \indent The mouse motor system contains multiple premotor areas and partially follows human organizational principles\newline
\item \indent The effects of genetic and modifiable risk factors on brain regions vulnerable to ageing and disease\newline
\item \indent SARS-CoV-2 is associated with changes in brain structure in UK Biobank\newline
\item \indent Image processing and Quality Control for the first 10,000 brain imaging datasets from UK Biobank\newline
\end{itemize}
...
\citemnobullet \textit{Department of Computer Science, University of Otago, Dunedin, New Zealand}
...
\indent The age-related posterior-anterior shift as revealed by voxelwise analysis of functional brain networks\newline\newline
...
\citemnobullet \textit{CSIRO, Hobart, Australia}
...
\citemnobullet \textit{Australian Defence Force Academy, Canberra, Australia}
...
\citemnobullet \textit{Department of Computer Science, University of South Australia, Adelaide, Australia}
...
\citemnobullet \textit{Llanberis, North Wales, UK}
